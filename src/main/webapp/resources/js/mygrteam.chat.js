...
mygrteam.chat = (function () {
    ...
    var configMap = {
            main_html: String() +
                '<div class="mygrteam-chat">' +
                '<div class="mygrteam-chat-head">' +
                '<div class="mygrteam-chat-head-toggle">+</div>' +
                '<div class="mygrteam-chat-head-title">' +
                'Chat' +
                '</div>' +
                '</div>' +
                '<div class="mygrteam-chat-closer">x</div>' +
                '<div class="mygrteam-chat-sizer">' +
                '<div class="mygrteam-chat-msgs"></div>' +
                '<div class="mygrteam-chat-box">' +
                '<input type="text"/>' +
                '<div>send</div>' +
                '</div>' +
                '</div>' +
    ...
    setJqueryMap = function () {
        var
            ...
            $slider = $append_target.find( '.mygrteam-chat' );

        jqueryMap = {
            $slider : $slider,
            $head : $slider.find( '.mygrteam-chat-head' ),
            $toggle : $slider.find( '.mygrteam-chat-head-toggle' ),
            $title : $slider.find( '.mygrteam-chat-head-title' ),
            $sizer : $slider.find( '.mygrteam-chat-sizer' ),
            $msgs : $slider.find( '.mygrteam-chat-msgs' ),
            $box : $slider.find( '.mygrteam-chat-box' ),
            $input : $slider.find( '.mygrteam-chat-input input[type=text]')
        };
    };
...
// End DOM method /setPxSizes/
    ...
    // Example : mygrteam.chat.setSliderPosition( 'closed' );
...
// End public DOM method /setSliderPosition/
    ...
    // Example : mygrteam.chat.configModule({ slider_open_em : 18 });
    ...
    // Example : mygrteam.chat.initModule( $('#div_id') );
